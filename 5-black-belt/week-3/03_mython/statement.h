...
struct VariableValue : Statement {
	...
	explicit VariableValue(std::vector<std::string> dotted_ids_);
...
struct Assignment : Statement {
	...
	Assignment(std::string var_name_, std::unique_ptr<Statement> rv);
	ObjectHolder Execute(Runtime::Closure& closure) override;
};
...
struct FieldAssignment : Statement {
	...
	FieldAssignment(VariableValue object_, std::string field_name_, std::unique_ptr<Statement> rv);
	ObjectHolder Execute(Runtime::Closure& closure) override;
};
...
public:
	explicit Print(std::unique_ptr<Statement> arg);
	explicit Print(std::vector<std::unique_ptr<Statement>> args_);
...
struct NewInstance : Statement {
	...
	NewInstance(const Runtime::Class& class__);
	NewInstance(const Runtime::Class& class__, std::vector<std::unique_ptr<Statement>> args_);
	ObjectHolder Execute(Runtime::Closure& closure) override;
};
...
public:
	explicit ClassDefinition(ObjectHolder class__);
